...
def display_all_employees(list_dict_employees):
    ...
    for list_dict_employee in list_dict_employees:
        print(list_dict_employee["ID"].ljust(10), "|", list_dict_employee["Name"].ljust(21), "|", str(locale.currency(
            float(list_dict_employee["Salary"]), grouping=True).ljust(14)), "|", list_dict_employee["Department"].ljust(11))
    print("")
    ...
    for x in range(len(list_dict_employees)):
        ...
        if list_dict_employees[x]["Department"] == "HR":
            ...
            if "Total_Salary" not in data_hr:
                data_hr["Total_Salary"] = float(
                    list_dict_employees[x]["Salary"])
            else:
                data_hr["Total_Salary"] = data_hr["Total_Salary"] + \
                    float(list_dict_employees[x]["Salary"])
        ...
        if list_dict_employees[x]["Department"] == "IT":
            ...
            if "Total_Salary" not in data_it:
                data_it["Total_Salary"] = float(
                    list_dict_employees[x]["Salary"])
            else:
                data_it["Total_Salary"] = data_it["Total_Salary"] + \
                    float(list_dict_employees[x]["Salary"])
        ...
        if list_dict_employees[x]["Department"] == "Admin":
            ...
            if "Total_Salary" not in data_admin:
                data_admin["Total_Salary"] = float(
                    list_dict_employees[x]["Salary"])
            else:
                data_admin["Total_Salary"] = data_admin["Total_Salary"] + \
                    float(list_dict_employees[x]["Salary"])
        ...
        if list_dict_employees[x]["Department"] == "Finance":
            ...
            if "Total_Salary" not in data_finance:
                data_finance["Total_Salary"] = float(
                    list_dict_employees[x]["Salary"])
            else:
                data_finance["Total_Salary"] = data_finance["Total_Salary"] + \
                    float(list_dict_employees[x]["Salary"])
...
def main():
    ...
    while True:
        ...
        input_function = input(
            "Please input your choice. (1 – 5, Enter to exit): ")
        if input_function == "":
            sys.exit()
        while True:
            try:
        ...
        # 2
            ...
            ldict = dict()
            while True:
                input_employee_name = input(
                    "Please input employee's name,Enter to return:")
            ...
            while True:
                if input_employee_name == "":
                    ...
                    break
                try:
                    input_employee_salary = input(
                        "Please input employee's salary,Enter to return:")
            ...
            while True:
                ...
                if input_employee_salary == "":
                    ...
                    main()
                    break
                input_employee_department = input(
                    "Please input employee's department,Enter to return:")
        ...
        # When user input 3 to remove employee record
            ...
            while True:
                input_employee_id = input(
                    "Please input employee's ID to remove record,Enter to return:")
            ...
            while True:
                ...
                try:
                    ...
                    print("Employee's ID record not found")
                    input_employee_id = input(
                        "Please input employee's ID,Enter to return:")
                    if input_employee_id == "":
                        print("")
                        input_function = None
                        main()
        ...
        # When user input 4 to update an employee salary
            ...
            while True:
                try:
                    input_employee_salary = input(
                        "Please input employee's updated salary,Enter to return:")
                    # When user pressed enter - break
                    if input_employee_salary == "":
                        input_function = None
                        main()
